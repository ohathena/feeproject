...
const KidsLittle = () => {
  ...
  const products = [
    { id: 1, name: 'Graphic T-Shirt', price: 699, category: 'tops', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&h=500&fit=crop', rating: 4.6 },
    { id: 2, name: 'Denim Jacket', price: 1599, category: 'outerwear', image: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=400&h=500&fit=crop', rating: 4.8 },
    { id: 3, name: 'Party Dress', price: 1899, category: 'dresses', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 4, name: 'Cargo Pants', price: 1299, category: 'bottoms', image: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=400&h=500&fit=crop', rating: 4.5 },
    { id: 5, name: 'Sports Set', price: 1499, category: 'activewear', image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=400&h=500&fit=crop', rating: 4.9 },
    { id: 6, name: 'Casual Shirt', price: 899, category: 'tops', image: 'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?w=400&h=500&fit=crop', rating: 4.4 },
  ];
    ...
    <div className="pt-[170px] min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-6xl font-serif text-gray-900 mb-4">Little Kids (5-7)</h1>
          <p className="text-xl text-gray-600">Fun & Trendy</p>
        </motion.div>
