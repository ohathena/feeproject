...
const KidsBaby = () => {
  ...
  const products = [
    { id: 1, name: 'Baby Romper Set', price: 899, category: 'rompers', image: 'https://images.unsplash.com/photo-1596870230751-ebdfce98ec42?w=400&h=500&fit=crop', rating: 4.8 },
    { id: 2, name: 'Soft Cotton Onesie', price: 599, category: 'onesies', image: 'https://images.unsplash.com/photo-1519689373023-dd07c7988603?w=400&h=500&fit=crop', rating: 4.9 },
    { id: 3, name: 'Baby Winter Jacket', price: 1299, category: 'outerwear', image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 4, name: 'Cute Bodysuit Pack', price: 799, category: 'onesies', image: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=400&h=500&fit=crop', rating: 4.6 },
    { id: 5, name: 'Baby Dress', price: 999, category: 'dresses', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=400&h=500&fit=crop', rating: 4.8 },
    { id: 6, name: 'Cozy Sleepsuit', price: 699, category: 'sleepwear', image: 'https://images.unsplash.com/photo-1612036782180-6f0b6cd846fe?w=400&h=500&fit=crop', rating: 4.5 },
  ];
    ...
    <div className="pt-[170px] min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-6xl font-serif text-gray-900 mb-4">Baby Fashion (0-3)</h1>
          <p className="text-xl text-gray-600">Adorable & Comfortable</p>
        </motion.div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg sticky top-32">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  {['all', 'rompers', 'onesies', 'dresses', 'outerwear', 'sleepwear'].map(cat => (
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: 'Under ₹700', range: [0, 700] },
                    { label: '₹700 - ₹1000', range: [700, 1000] },
                    { label: 'Above ₹1000', range: [1000, 5000] },
                  ].map(option => (
