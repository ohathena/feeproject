...
const Women = () => {
  ...
  const products = [
    ...
    { id: 5, name: 'Designer Dress', price: 5999, category: 'dresses', image: 'https://kaykaylabel.com/cdn/shop/files/KayKay-00223copy.jpg?v=1719553274&width=1800', rating: 4.9 },
    ...
    { id: 7, name: 'Premium Coat', price: 7999, category: 'outerwear', image: 'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTIMvYjRaDTxJfuKqFLf28AQUtVdePz7i0z-mwvSc4ssMj5lIRBcgVU3yNuEzMuQL2_Eroidh5AazZZEErD8kfYTR-sRHJwVGBvrzcmu4zCPTS_9_kJ-Tzqig', rating: 4.7 },
    { id: 8, name: 'Trendy Summer Wear', price: 1999, category: 'tops', image: 'https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSSOBryZgtczBHMyCMMXRXyuwwQmkzY4Xk0YkqizfdriMovVd1gNpZoosBi5CpoyeduHhkIUzRvbw0pzNgCXg0JOxh1lcqelSuE4GQRa4dS', rating: 4.2 },
  ];
