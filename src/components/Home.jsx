...
const [currentIndex, setCurrentIndex] = useState(0);
  ...
  return (
    <div className="min-h-screen ">
          ...
          <div className="grid grid-cols-4 divide-x divide-gray-100">
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="relative text-center py-16 px-8 cursor-pointer group transition-all duration-500 hover:bg-gray-50/50"
              >
                {/* Minimal hover indicator */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gray-900 group-hover:w-16 transition-all duration-700 ease-out" />

                {/* Icon */}
                <div className="text-5xl mb-8 text-gray-800 group-hover:text-gray-900 transition-colors duration-700">
                  {feature.symbol}
                </div>

                {/* Refined divider */}
                <div className="w-12 h-[0.5px] bg-gray-300 mx-auto mb-6" />

                {/* Title */}
                <h3 className=" text-base uppercase tracking-[0.2em] text-gray-900 mb-4 letter-spacing-wide">
                  {feature.title}
                </h3>

                {/* Description */}
                <p className="text-sm text-gray-500 leading-loose font-light max-w-[200px] mx-auto">
                  {feature.desc}
                </p>
              </motion.div>
            ))}
      ...
      <section className="min-h-screen py-12 px-8 bg-gradient-to-b from-white to-rose-50/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-4 gap-8">
            {[
              ...
              { name: "Luxury Lipstick", category: "Makeup", price: "₹2,800", image: "https://www.rasluxuryoils.com/cdn/shop/files/ChampaigneBlush_c2484f01-b702-4092-97e8-c24419530452.jpg?v=1710490244&width=600" },
              { name: "Hydrating Mist", category: "Skincare", price: "₹3,500", image: "https://aflairza.com/cdn/shop/files/Hydratante1st2.jpg?v=1749987561&width=1024" },
              { name: "Night Cream", category: "Skincare", price: "₹5,200", image: "https://mitchellmalaysia.com/cdn/shop/files/MitchellUsa_AgeLess_NightTherapy_Cream-01_1.webp?v=1729493846&width=713" },
              { name: "Rose Gold Palette", category: "Makeup", price: "₹6,800", image: "https://i.pinimg.com/736x/1c/20/bc/1c20bc566b235fb4dd6d2735a17a7b96.jpg" },
              { name: "Body Lotion", category: "Body Care", price: "₹3,200", image: "https://lovebeautyandplanet.in/cdn/shop/files/Cherry_blossom_body_lotion.jpg?v=1757130547&width=713" },
      ...
      <section className="min-h-screen flex items-center justify-center bg-gray-800/90 relative overflow-hidden py-32">
        ...
        <motion.div
          ...
          className="relative z-10 max-w-6xl mx-auto px-16 text-center"
        >
          <motion.div
          ...
          >
            {/* Top accent line */}
            <div className="w-32 h-[0.5px] bg-white/30 mx-auto mb-12" />

            {/* Subtitle */}
            <p className="text-white/50 text-xs uppercase tracking-[0.4em] mb-8 font-light">
              Our Philosophy
            </p>

            {/* Main heading */}
            <h2 className="text-7xl font-light text-white mb-6 leading-[1.1] tracking-tight">
            ...
            {/* Divider */}
            <div className="w-24 h-[0.5px] bg-white/20 mx-auto my-10" />

            {/* Description */}
            <p className="text-lg text-white/60 mb-20 max-w-2xl mx-auto leading-loose font-light">
            ...
            {/* Stats section */}
            <div className="flex gap-20 justify-center items-center max-w-4xl mx-auto">
              <div className="flex-1 text-center group cursor-default">
                ...
                >
                  <div className="text-7xl font-light text-white mb-4 group-hover:text-white/90 transition-colors duration-500">
                    10K+
                  </div>
                  <div className="w-12 h-[0.5px] bg-white/20 mx-auto mb-4 group-hover:w-20 transition-all duration-500" />
                  <div className="text-white/50 text-xs uppercase tracking-[0.3em] font-light">
                    Happy Customers
                  </div>
                </motion.div>
              </div>

              <div className="w-[0.5px] h-24 bg-white/10" />
        ...
        <div className="relative flex items-center justify-center gap-6 px-4">
          <AnimatePresence mode="wait">
            ...
            <motion.div
              ...
              className="bg-neutral-50 p-8 border border-gray-200 w-72 h-72 flex-shrink-0 flex flex-col justify-between"
            >
              <div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="bg-white p-12 border-2 border-gray-800 w-96 h-96 flex-shrink-0 flex flex-col justify-between shadow-2xl z-10"
            >
              <div>
              ...
              <div>
                <p className="font-bold text-gray-900 tracking-wide text-lg">{testimonials[centerIdx].name}</p>
                <p className="text-sm text-gray-600 uppercase tracking-wider mt-1">{testimonials[centerIdx].location}</p>
              </div>
            </motion.div>
          ...
          {testimonials.map((_, idx) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                idx === currentIndex ? 'bg-gray-800 w-8' : 'bg-gray-300'
              }`}
