...
const KidsBig = () => {
  ...
  const products = [
    { id: 1, name: 'Stylish Hoodie', price: 1499, category: 'tops', image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 2, name: 'Denim Jeans', price: 1799, category: 'bottoms', image: 'https://images.unsplash.com/photo-1582552938357-32b906df40cb?w=400&h=500&fit=crop', rating: 4.6 },
    { id: 3, name: 'Winter Jacket', price: 2499, category: 'outerwear', image: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=400&h=500&fit=crop', rating: 4.8 },
    { id: 4, name: 'Sports Jersey', price: 1299, category: 'activewear', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&h=500&fit=crop', rating: 4.5 },
    { id: 5, name: 'Casual Dress', price: 1999, category: 'dresses', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 6, name: 'Track Pants', price: 1199, category: 'bottoms', image: 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=400&h=500&fit=crop', rating: 4.4 },
  ];
    ...
    <div className="pt-[170px] min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-6xl font-serif text-gray-900 mb-4">Big Kids (7-12)</h1>
          <p className="text-xl text-gray-600">Cool & Confident</p>
        </motion.div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg sticky top-32">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  {['all', 'tops', 'bottoms', 'dresses', 'outerwear', 'activewear'].map(cat => (
