...
const KidsTeens = () => {
  ...
  const products = [
    { id: 1, name: 'Trendy Hoodie', price: 1999, category: 'tops', image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=400&h=500&fit=crop', rating: 4.8 },
    { id: 2, name: 'Skinny Jeans', price: 2299, category: 'bottoms', image: 'https://images.unsplash.com/photo-1582552938357-32b906df40cb?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 3, name: 'Bomber Jacket', price: 2999, category: 'outerwear', image: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=400&h=500&fit=crop', rating: 4.9 },
    { id: 4, name: 'Athletic Wear Set', price: 2499, category: 'activewear', image: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?w=400&h=500&fit=crop', rating: 4.6 },
    { id: 5, name: 'Casual Dress', price: 2199, category: 'dresses', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=400&h=500&fit=crop', rating: 4.7 },
    { id: 6, name: 'Graphic Tee', price: 999, category: 'tops', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=400&h=500&fit=crop', rating: 4.5 },
  ];
    ...
    <div className="pt-[170px] min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-6xl font-serif text-gray-900 mb-4">Teen Fashion (12+)</h1>
          <p className="text-xl text-gray-600">Bold & Expressive</p>
        </motion.div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: 'Above ₹2500', range: [2500, 8000] },
                  ].map(option => (
