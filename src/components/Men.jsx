...
const Men = () => {
  ...
  const products = [
    { id: 1, name: 'Classic Blazer', price: 5499, category: 'formal', image: '/products/jacket1.jpg', rating: 4.7 },
    { id: 2, name: 'Winter Overcoat', price: 6999, category: 'outerwear', image: '/products/coat1.jpg', rating: 4.8 },
    { id: 3, name: 'Casual Jacket', price: 3999, category: 'casual', image: '/products/jacket1.jpg', rating: 4.5 },
